...
public class LAIS2 {
	...
	public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            for(int i=1;i<n;i++){
                for(int j=0;j<i;j++){       
                    if(a[i]>=a[j]){// if current is bigger or equal to jiske peeche lgna hai
                        ...
                        if(temp[j]<=a[i]){ // vrna jiske peeche tum lgne jaare ho uske aage vale se 
                            // barabar ya bde hone chahiyo
