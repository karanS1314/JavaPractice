...
public class BoxFit {
    public static int min_bound(int x , ArrayList<Integer> al  , int l , int r){
	...
	public static void main(String[] args) {
        ...
        while(t-->0){
            ...
            // search for the min bound of W-sm in array from 0 -> j until 
            // its not present and then increase the count by 1
